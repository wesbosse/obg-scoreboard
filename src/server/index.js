    ...
    Jimp.read(url, (err, overlay) => {
        ...
        Jimp.loadFont(Jimp.FONT_SANS_64_BLACK).then(font1 => {
            Jimp.loadFont(Jimp.FONT_SANS_32_BLACK).then(font2 => {
                ...
                overlay.print(font1, 1560, 375, imageData.players[0].score); // player 1 score
                overlay.print(font1, 1700, 375, imageData.players[0].cp); // player 1 CP
                ...
                overlay.print(font1, 1560, 595, imageData.players[1].score); // player 2 score
                overlay.print(font1, 1700, 595, imageData.players[1].cp); // player 2 CP
                return overlay
            }).then(overlay => {
